...
final class TextFormat {
    ...
    public static function toHTML(string $text): string {
        $htmlColors = [
            self::BLACK => '<span style="color:
            self::DARK_BLUE => '<span style="color:
            self::DARK_GREEN => '<span style="color:
            self::DARK_AQUA => '<span style="color:
            self::DARK_RED => '<span style="color:
            self::DARK_PURPLE => '<span style="color:
            self::GOLD => '<span style="color:
            self::GRAY => '<span style="color:
            self::DARK_GRAY => '<span style="color:
            self::BLUE => '<span style="color:
            self::GREEN => '<span style="color:
            self::AQUA => '<span style="color:
            self::RED => '<span style="color:
            self::LIGHT_PURPLE => '<span style="color:
            self::YELLOW => '<span style="color:
            self::WHITE => '<span style="color:
            self::MINECOIN_GOLD => '<span style="color:
            self::BOLD => '<b>',
            self::ITALIC => '<i>',
            self::UNDERLINE => '<u>',
